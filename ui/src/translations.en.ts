...
export const messagesEnglish = {
    ...
    'playerSheetTab.kickShipWarning.wildsea': 'Here be Terrapex\'s! This action cannot be undone. All data for this ship will be permanently deleted.',
    'playerSheetTab.kickShipWarning.deltaGreen': 'Here be anomalies! This action cannot be undone. All data for this ship will be permanently deleted.',
